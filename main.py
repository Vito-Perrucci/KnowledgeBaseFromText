...
class KB():  #this version is the complete one with the add of 'merge_relations' and the edit of 'add_relation'
...
#functions made for the creation of the KB (normal text)
...
#creation of the KB from a normal text
