...
#definitive version of the class KB
class KB():
    ...
    def merge_relationsUrl(self, r2):
...
#function made for the creation of the KB (normal text)
    ...
    for sentence_pred in decoded_preds:
        ...
        if mode == 1:
            for relation in relations:
                ...
                kb.add_relation(relation, None, None)
...
#function that transform an url to a text
def get_article(url):
    article = Article(url)
    article.download()
    article.parse()
...
#function made for the creation of the KB (one url) 
def from_url_to_kb(url):
    ...
    kb = from_text_to_kb(article.text, article.url)
    return kb


#this function returns a list of news article link
...
#function made for the creation of the KB (more urls) 
